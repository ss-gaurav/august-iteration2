...
colors = [(255,0,0), (0,0,255), (255, 255,255) , (255, 255, 0)]
...
csv_log_file1 = os.path.join(output_folder, 'log1.csv')
    ...
    for video_file in video_files:
        ...
        while cap.isOpened():
            ...
            for x in range (0, width , steps):
                color = colors[(x//steps)%len(colors)]
            ...
            if len(detected_box) == 2:
                ...
                log_data1.append([disparity, int(detected_box[0]), int(detected_box[1])])
...
df_log1 = pd.DataFrame(log_data1, columns=log_columns1)
df_log1.to_csv(csv_log_file1, index=False)
